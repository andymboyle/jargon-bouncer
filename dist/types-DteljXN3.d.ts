...
type Category = "stack-trace" | "database-error" | "network-error" | "cloud-error" | "orm-error" | "exception-class" | "file-path" | "serialized-data";
/**
...
export type { Classification as C, Pattern as P, SanitizeOptions as S, Category as a };
